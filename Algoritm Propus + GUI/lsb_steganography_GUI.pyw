...
import lsb_steganography as stego  # alg
...
class Ui_MainWindow(object):
    ...
    def getFile(self):
        file_path = QtWidgets.QFileDialog.getOpenFileName(None, 'Open file','',"Image files (*.png *.bmp)")[0]
        if file_path != '':
            self.lineEdit.setText(file_path)
            
            
    #Function to choose input file Pixels
    def getFilePixels(self):
        file_path = QtWidgets.QFileDialog.getOpenFileName(None, 'Open file','',"Pixels Encrypted Files (*.enc)")[0]
        if file_path != '':
            self.lineEdit_0.setText(file_path)
    ...
    def encode(self):
        ...
        passwordPhoto = self.lineEdit_2.text()
        passwordPixels = self.lineEdit_21.text()
        if input_path == '':
            ...
            self.displayMsg('Error: No password','Please enter a password for Photo!','err')
        elif passwordPixels == '':
            self.displayMsg('Error: No password','Please enter a password for Pixels!','err')
        else:
            ...
            if output_path == '':
                ...
                try:
                    stego.encode(input_path,text, output_path, passwordPhoto, passwordPixels, self.progressBar)
    ...
    def decode(self):
        input_path = self.lineEdit.text()
        input_path_Pixels = self.lineEdit_0.text()
        passwordPhoto = self.lineEdit_3.text()
        passwordPixels = self.lineEdit_31.text()
        if input_path == '':
            self.displayMsg('Error: No file chosen','You must select input image file!','err')
        elif input_path_Pixels == '':
            self.displayMsg('Error: No file chosen','You must select input Pixels file!','err')
        elif passwordPhoto == '':
            self.displayMsg('Error: No password','Please enter a password for Photo!','err')
        elif passwordPixels == '':
            self.displayMsg('Error: No password','Please enter a password for Pixels!','err')
            ...
            try:
                data = stego.decode(input_path, input_path_Pixels, passwordPhoto, passwordPixels, self.progressBar_2)
            except stego.FileError as fe:
                self.displayMsg('File Error',str(fe),'err')
    ...
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_20.addWidget(self.lineEdit_0)
        self.pushButton_1 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_1.setAutoFillBackground(False)
        self.pushButton_1.setAutoDefault(True)
        self.pushButton_1.setObjectName("pushButton_1")
        self.horizontalLayout_20.addWidget(self.pushButton_1)
        ...
        self.horizontalLayout_0.addWidget(self.label_20)
        self.verticalLayout_5.addLayout(self.horizontalLayout_0)
        ...
        self.horizontalLayout_31.addWidget(self.checkBox_1)
        ...
        self.horizontalLayout_41.addWidget(self.lineEdit_31)
        self.checkBox_2 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_2.setObjectName("checkBox_2")
        self.checkBox_3 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_3.setObjectName("checkBox_3")
        self.horizontalLayout_4.addWidget(self.checkBox_2)
        self.horizontalLayout_41.addWidget(self.checkBox_3)
        ...
        self.pushButton_1.clicked.connect(self.getFilePixels)
        ...
        self.checkBox_1.stateChanged.connect(lambda: self.lineEdit_21.setEchoMode(QtWidgets.QLineEdit.Normal) if self.checkBox_1.isChecked() else self.lineEdit_21.setEchoMode(QtWidgets.QLineEdit.Password))
        ...
        self.checkBox_3.stateChanged.connect(lambda: self.lineEdit_31.setEchoMode(QtWidgets.QLineEdit.Normal) if self.checkBox_3.isChecked() else self.lineEdit_31.setEchoMode(QtWidgets.QLineEdit.Password))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_40.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Step 1.5:</span></p></body></html>"))
        self.label_30.setText(_translate("MainWindow", "Input Pixels Encoded File:"))
        self.pushButton_1.setText(_translate("MainWindow", "Choose File"))
        ...
        self.label_9.setText(_translate("MainWindow", "Password Photo:"))
        self.checkBox.setText(_translate("MainWindow", "Show"))
        self.label_91.setText(_translate("MainWindow", "Password Pixels:"))
        self.checkBox_1.setText(_translate("MainWindow", "Show"))
        ...
        self.label_10.setText(_translate("MainWindow", "Password Photo:"))
        self.checkBox_2.setText(_translate("MainWindow", "Show"))
        self.label_101.setText(_translate("MainWindow", "Password Pixels:"))
